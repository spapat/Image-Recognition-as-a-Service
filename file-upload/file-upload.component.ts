...
export class FileUploadComponent implements OnInit {
  imageUrls = [];
  imageFiles: any[] = [];
  BucketName = 'input-image';
  accessKeyId = 'AKIATSRIJ7WFBC7EBCPG';
  secretAccessKey = '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';
  region = 'us-east-1';
  launchQueueUrl =
    'https://sqs.us-east-1.amazonaws.com/245971418506/Launch-Queue';
  uploadSuccess = false;
  imagesDataSet = [];
